<%-- 
    Document   : navabradmin.jsp
    Created on : Jan 13, 2021, 10:13:13 AM
    Author     : nguye
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="MainController?btnAction=ShowHomePage">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="MainController?btnAction=ShowAddFoodPage">Add Food</a>
                        </li>
                        <li class="nav-item">
                            <p  class="nav-link">Welcome ${sessionScope.USER.fullName}</p>
                        </li>
                        <li class="nav-item">
